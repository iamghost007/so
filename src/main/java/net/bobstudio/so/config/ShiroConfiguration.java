...
public class ShiroConfiguration {
	...
	public ShiroFilterFactoryBean getShiroFilterFactoryBean(){
		...
		filterChainDefinitions.put("/accounts/**", "perms[account:*]");
		filterChainDefinitions.put("/roles/**", "perms[account:*]");
		filterChainDefinitions.put("/products/**", "perms[product:*]");
		filterChainDefinitions.put("/materials/**", "perms[product:*]");
		filterChainDefinitions.put("/plans/**", "perms[plan:*]");
	...
	public SimpleMappingExceptionResolver getMappingExceptionResolver(){
		...
		mappings.put("org.apache.shiro.authz.UnauthenticatedException", "/unauthorized");
		mappings.put("org.apache.shiro.authc.DisabledAccountException", "/403");
